...
{
    /// <summary>
    /// Pour lier les boutons de la barre d'outils à leurs actions
    /// </summary>
        ...
        private static void OnUpdate()
        {
            if (m_currentToolbar == null)
            {
                ...
                if (m_currentToolbar != null)
                {
                    ...
                    VisualElement mRoot = root.GetValue(m_currentToolbar) as VisualElement;
